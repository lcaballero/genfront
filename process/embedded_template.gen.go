...
func req_rest_methodsFm() (*asset, error) {
	...
	info := bindataFileInfo{name: "req_rest_methods.fm", size: 477, mode: os.FileMode(420), modTime: time.Unix(1465978320, 0)}
...
func struct_sql_tomapFm() (*asset, error) {
	...
	info := bindataFileInfo{name: "struct_sql_tomap.fm", size: 2674, mode: os.FileMode(420), modTime: time.Unix(1477981408, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
